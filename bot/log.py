...
class Logger:
    ...
    def __init__(self, logging_agent, log_webhook_url, tweet_webhook_url=None):
        ...
        discord_log_handler = DiscordHandler(log_webhook_url)
        ...
        if tweet_webhook_url:
            tweet_format = TWEET_FORMAT
            discord_tweet_handler = DiscordHandler(tweet_webhook_url, logging_agent)
